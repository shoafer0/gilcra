...
- Mozzu
	- bleed dmg - 
- Xan
	- fireball 4th lvl - 40 dmg
		- x1 *dead*
- Dorvik
	- sharpshooter (assassin) - 17TH / 31 *dead*
		- sharpshooter / fury / sneak attack
	- sharpshooter (brute) - 18TH / 36 *dead*
	- ba - hide - 25
- Malerai - *dead*
- Bis
	- death save - unknown - danny rolled
- Pip
	- revivify (Carric) - does not work *counter spell*
- River
	- Eldritch Blast ( ) - 
	- Eldritch Blast ( ) - 
- Twisted Scales
	- mage - *invisible*
	- heavy crossbow (Dorvik) - 19TH / miss
	- heavy crossbow (Dorvik) - 27TH / 11 piercing 2 poison
	- shocking grasp (Aya) - 15 lightning
	- heavy crossbow (MA-TCHES) - 27TH / 1 poison
		- Con Save - MA-TCHES Pass
- Lt Cmdr
	- longsword (brute) 21TH / 16
	- longsword (mage) ?TH / 18
	- longsword (mage) 22TH / 14 *dead*
- Carric - *dead*
- Aya
	- fly with nightmare
	- grab rose from pip's back
	- ba - use rose to heal - full HP recovery 
	- action - dash
- MA-TCHES
	- cure wounds (Bis) - 8 hp
	- ba - guardian field - 10 temp hp
